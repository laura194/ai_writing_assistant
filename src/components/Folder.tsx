      ...
      <div className="flex items-center gap-2">
        ...
        <motion.div
          ...
          className={`relative flex items-center justify-center w-9 h-9 rounded-full transition-colors duration-200 
            ${showIconPicker ? "bg-gradient-to-tr from-indigo-600 to-purple-400 shadow-[0_0_20px_rgba(120,69,239,0.4)]" : "bg-[#2e214b] hover:bg-[#443764] shadow-[0_0_10px_rgba(120,69,239,0.1)]"}
        ...
        >
          <div
            className={`flex items-center justify-center w-8 h-8 rounded-full bg-[#1e1538] 
              ${
                showIconPicker
                  ? "text-[#faf8ff]"
                  : "text-[#a396c4] group-hover:text-white"
              }`}
          >
        ...
        {isEditing && node.id !== "1" ? ( // Bearbeiten nur ermöglichen, wenn es sich nicht um "1" handelt
          <input
            ref={inputRef}
            className="w-full bg-transparent border border-[#1f1630] px-3 py-1 rounded-lg
          ...
          <motion.span
            ...
            whileTap={{ scale: 0.95 }}
            className={`flex-1 min-w-0 whitespace-normal break-words cursor-pointer px-3 py-2 rounded-lg transition-all duration-250 
              ${
                isSelected
                  ? `text-white bg-transparent border border-transparent`
                  : `hover:bg-[#312350] hover:shadow-[0_0_8px_rgba(120,69,239,0.2)] border border-transparent transition-all duration-250`
              }`}
            onDoubleClick={() => {
              if (node.id !== "1") {
        ...
        <motion.button
          ...
          className="text-green-500 hover:text-green-300 transition duration-300 cursor-pointer"
          title="Add chapter"
        >
        ...
        {node.id !== "1" && (
          <motion.button
            ...
            className="text-red-400 hover:text-red-300 transition duration-300 cursor-pointer"
        ...
        >
          <ul
            className={`pl-4 space-y-1 ${
              node.id !== "1" ? "border-l border-[#32265b]/80 ml-0.5" : ""
            }`}
          >
             ...
             w-[300px] mx-auto"
              >
                <div className="group flex items-center justify-center bg-[#1e1538] bg-opacity-90 backdrop-blur-md p-4 rounded-xl shadow-inner shadow-red-500/30 border border-[#471717]">
                  <Trash2 className="w-7 h-7 stroke-[#ffcccc]" />
