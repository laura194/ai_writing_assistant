...
export const FAQDropdown = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Word (.docx), PDF (.pdf), and LaTeX (.tex) for academic publishing needs.",
        },
        {
            question: "Is it free?",
        ...
        "
            >
                ...
                <div className="space-y-2">
                    {faqs.map((faq, index) => (
                        <div key={index} className="border-b border-[#aca0d6] dark:border-[#32265b] pb-2">
                            <button
                            ...
                            {openIndex === index && (
                                <p className="mt-1 text-[#261e3b] dark:text-[#afa6c5]">{faq.answer}</p>
                            )}
                        </div>
                    ))}
                </div>
