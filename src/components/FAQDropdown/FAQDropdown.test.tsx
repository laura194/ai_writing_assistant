...
describe("FAQDropdown component", () => {
    test("renders FAQ button and dropdown structure", () => {
        ...
        const dropdown = screen.getByText("Frequently Asked Questions").closest("div");
    ...
    test("toggles FAQ answer on question click", () => {
        ...
        expect(screen.queryByText(/A web app that helps students/i)).not.toBeInTheDocument();

        // Click to open
        fireEvent.click(questionButton);
        expect(screen.getByText(/A web app that helps students/i)).toBeInTheDocument();
    ...
    test("only shows one answer at a time", () => {
        ...
        expect(screen.queryByText(/A web app that helps students/i)).not.toBeInTheDocument();
        expect(screen.getByText(/It assists with structuring arguments/i)).toBeInTheDocument();
    });
});
