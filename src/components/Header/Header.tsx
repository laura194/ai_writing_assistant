  ...
  return (
    <header className="fixed top-0 left-0 w-full h-14 pl-6 pr-8 backdrop-blur-md bg-[#e7e3f6]/75 dark:bg-[#1e1538]/75 border-b border-[#beb1e7] dark:border-[#332857] shadow-[0_4px_50px_rgba(0,0,0,0.175)] dark:shadow-[0_4px_50px_rgba(0,0,0,0.3)] z-50 flex items-center">
      ...
      >
        ...
        />
        <span className="font-semibold text-lg tracking-wide bg-gradient-to-r from-purple-400 via-pink-400 to-yellow-300 bg-clip-text text-transparent transition-filter duration-200 group-hover:drop-shadow-[0_0_8px_#664aa8] dark:group-hover:drop-shadow-[0_0_12px_#9469f7] uppercase">
          AI Writing Assistant
        </span>
      </Link>

      {/* Center: Navigation */}
      <nav className="hidden md:flex flex-1 justify-center gap-8 text-sm font-medium dark:text-[#afa6c5] text-[#261e3b]">
        <Link
