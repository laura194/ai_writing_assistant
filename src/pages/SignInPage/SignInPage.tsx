    ...
    <main className="min-h-screen flex flex-col lg:flex-row bg-[#090325] overflow-x-hidden">
      ...
      <motion.section
        ...
        className="relative lg:w-2/5 flex items-center justify-center p-14 
             bg-gradient-to-br from-[#a989ef] to-[#442c76] overflow-hidden"
      >
        {/* The Circles */}
        <motion.div
          className="absolute -top-12 -left-12 w-52 h-52 rounded-full bg-[#372363] opacity-25"
        ...
        />
        <motion.div
          className="absolute -bottom-16 -right-16 w-64 h-64 rounded-full bg-[#aea9ce] opacity-20"
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              "linear-gradient(90deg, #FF4ED0, #00FFA3, #915EFF)",
        ...
        >
          <div className="bg-[#151030] rounded-[18px] min-h-[55vh] flex flex-col items-center text-center p-4">
            ...
            >
              ...
              <br />
              The AI is warmed up and ready to refine your next breakthrough.
              Let's turn blank pages again into a canvas of your ideas. Sign In
              to move your academic writing forward.
            </p>
      ...
      <motion.section
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1.8 }}
        className="lg:w-3/5 flex items-center justify-center p-14"
      >
        <div className="w-full bg-[#180d33] rounded-2xl shadow-xl p-4 relative overflow-hidden">
          {/* Blinking Circles */}
          <motion.div
            className="absolute -top-16 -right-16 w-72 h-72 rounded-full bg-[#8b5cf6] opacity-15"
            animate={{ opacity: [0.25, 0.6, 0.25] }}
            transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute -bottom-12 left-16 transform -translate-x-1/2 w-48 h-48 rounded-full bg-[#bf93ef] opacity-10"
          ...
          <div className="mb-10 text-center">
            <i
              className="bx bx-user-circle text-7xl text-[#9a7cf5] mb-6"
              data-aos="fade-down"
              data-aos-delay="600"
              data-aos-duration="1200"
            ></i>
            ...
            <p
              ...
              data-aos-duration="500"
            >
              Access your personal workspace and continue refining your writing.
            </p>
          </div>
          {/* SignIn Form */}
          <div
