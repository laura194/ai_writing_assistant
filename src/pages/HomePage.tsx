...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#090325] text-white relative overflow-hidden flex flex-col items-center">
      ...
      />
      <div className="absolute top-[52.5%] left-1/2 w-[880px] h-[880px] bg-[#9a58eb] opacity-15 blur-3xl rounded-full -translate-x-1/2 -translate-y-1/2 pointer-events-none mix-blend-screen z-0" />
      <motion.div
          ...
          >
            <div className="bg-[#1e1538] rounded-3xl px-10 py-10 text-center w-full min-h-[720px]">
              ...
              >
                ...
                Let our AI be your co-writer - precise, reliable, and always by
                your side, from your first sentence to the final polish.
                <br />
                <span className="block h-3" />
                ...
                <br />
                <strong>
                  Create a new project or continue an existing one - seamlessly.
                </strong>
              </p>
