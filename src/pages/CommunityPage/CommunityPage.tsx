                    ...
                    >
                        ...
                        >
                            <div className="w-full max-w-3xl bg-[#e9e5f8] dark:bg-[#1e1538] rounded-3xl px-10 py-10 shadow-[0_0_40px_rgba(251,146,60,0.2)]">
                                ...
                                >
                                    Explore published projects from the community. Discover work by
                                    other users, view categories, and find inspiration.
                                </p>
                      ...
                      <span className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-600 bg-clip-text text-transparent">
                        No community projects yet.
                              ...
                              {project.authorName}
                                                    ...
                                                    {project.tags && project.tags.length > 0 && (                                                        <div className="flex flex-wrap gap-2 mt-2">
